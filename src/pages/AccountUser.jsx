...
export default function AccountUser() {
  ...
  return (
    <>
        ...
        <Container className={classes.box} maxWidth="xs">
          ...
          >
            ...
            <Box component="form" noValidate sx={{ mt: 3 }}>
              ...
              <Typography className={classes.titleTransacao}>Realizar Transação</Typography>

              <Grid container spacing={2}>
                <Grid item xs={12} sm={5}>
                  <FormControl sx={{ m: 1, minWidth: 150 }}>
                    <InputLabel id="tipo">Tipo</InputLabel>
                    <Select labelId="tipo-label" id="tipo" value={tipo} label="Tipo" onChange={handleChange}>
                ...
                <Grid item xs={12} sm={7}>
                  <Button fullWidth variant="contained" sx={{ mt: 3, mb: 2 }} onClick={handleDialog}>
                    Adicionar Transação
                  </Button>
                </Grid>
              </Grid>
      ...
      <Transacao open={dialogOpened} onClose={handleDialog} user={user !== undefined && user} type={tipo} />
